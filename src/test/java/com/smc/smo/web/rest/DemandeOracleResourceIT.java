...
class DemandeOracleResourceIT {
    ...
    void createDemandeOracle() throws Exception {
        ...
        restDemandeOracleMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(demandeOracle)))
    ...
    void putWithMissingIdPathParamDemandeOracle() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restDemandeOracleMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(demandeOracle)))
    ...
    void patchWithMissingIdPathParamDemandeOracle() throws Exception {
        ...
        restDemandeOracleMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(demandeOracle))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteDemandeOracle() throws Exception {
        ...
        restDemandeOracleMockMvc
            .perform(delete(ENTITY_API_URL_ID, demandeOracle.getId()).accept(MediaType.APPLICATION_JSON))
